...
# reviewTime: Değerlendirme zamanı Raw   # ham
...
df = pd.read_csv("Week4/case_study_I/amazon_review.csv")
...
# day_diff: Değerlendirmeden itibaren geçen gün sayısı data setimizde mevcut
...
# burada helpfull [ , ] değişkenine de bakarak sağlama yapabiliriz.
